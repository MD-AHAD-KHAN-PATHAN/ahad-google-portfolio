...
const Contact = () => {
    return (
        <div className='lg:mt-20 lg:m-0 m-4'>
            <div className="grid md:grid-cols-2 grid-cols-1">
            <div className="">
                <h1 className="text-4xl font-bold">Contact Information</h1>
                <p className="font-bold my-6 flex items-center gap-2"><span className=''><MdMarkEmailRead></MdMarkEmailRead></span>md.ahadkhanpathan.tct@gmail.com</p>
